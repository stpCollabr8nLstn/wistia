export const jobs = {
    ...
    location: {
      ...
      body:
        "With flexible workstations, plenty of natural light, and a wall of snackity snacks—we love our homey Cambridge office. ",
      link: "Tour our office",
    },
    values: {
      heading: "Rooted in values",
      body:
        "Our values help everyone at Wistia make decisions that help us build a happy, lasting company focused on product leadership. ",
      link: "See our values"
    },
    human: {
      heading: "Committed to being human",
      body:
        "We’re a team of hard-working, high-fiving, friendly humans (and one hardly-working dog) ready to take on the video world. ",
      link: "Meet the team"
    },
    pushing: {
